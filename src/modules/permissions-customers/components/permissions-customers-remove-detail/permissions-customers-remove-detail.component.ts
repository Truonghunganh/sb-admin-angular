...
@Component({
    selector: 'sb-permissions-customers-remove-detail',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './permissions-customers-remove-detail.component.html',
    styleUrls: ['permissions-customers-remove-detail.component.scss'],
})
export class PermissionsCustomersRemoveDetailComponent implements OnInit {
    userId = 0;

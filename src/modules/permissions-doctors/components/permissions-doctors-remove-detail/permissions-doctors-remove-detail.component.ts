...
@Component({
    selector: 'sb-permissions-doctors-remove-detail',
    changeDetection: ChangeDetectionStrategy.OnPush,
    templateUrl: './permissions-doctors-remove-detail.component.html',
    styleUrls: ['permissions-doctors-remove-detail.component.scss'],
})
export class PermissionsDoctorsRemoveDetailComponent implements OnInit {
    userId = 0;
